...
class SpoAbstract extends Component {
  ...
  handleChange = (e) => {
    ...
    // spo2Less95Time = parseFloat(spo2Less95Time/60,10).toFixed(1)
    // spo2Less90Time = parseFloat(spo2Less90Time/60,10).toFixed(1)
    // spo2Less85Time = parseFloat(spo2Less85Time/60,10).toFixed(1)
    // spo2Less80Time = parseFloat(spo2Less80Time/60,10).toFixed(1)
    handleInputChange({
      ...data,
          ...
          <span>
            {
              isEditting?
                <Input 
                  type="number" 
                  name="diffThdLge3Cnts"
                  value={ diffThdLge3Cnts }
                  onChange={ this.handleChange }
                />
...
const mapStateToProps = state => (
  {
    ...
    diffThdLge3Cnts: state.report.adviceData.diffThdLge3Cnts,
    diffThdLge3Pr: state.report.adviceData.diffThdLge3Pr,
