      ...
      <div className="block">
        ...
        <div className="table-data">
          <span>
            <span>
              {/* { edition.name || '--' } */}
              {isEditting ? <div><Input name="name" style={{ width: '1rem' }} value={edition.name} onChange={this.handleChange} /></div> : (edition.name || '--')}
            </span>
          ...
          <span>
            <span>
              ...
              {isEditting ? <div>
                <Select name="gender" style={{ width:'1rem' }} showArrow={false} value={selectedGender} onChange={this.handleChange}>
          ...
          <span>
            <span>
              ...
              {isEditting ?
                <div>
                  <Input name="age" style={{ width: '1rem' }} value={edition.age} onChange={this.handleChange}/>
                </div> :
                (edition.age || '--')
              }
            </span>
          ...
          <span>
            <span>
              {/* {edition.height + 'cm' || '--'} */}
              {isEditting ? <div>
                  <Input name="height" style={{ width: '1rem' }} value={(edition.height)} onChange={this.handleChange} />
          ...
          <span>
            <span>
              {/* {edition.weight + 'Kg' || '--'} */}
              {isEditting ? <div>
                  <Input name="weight" style={{ width: '1rem' }} value={edition.weight} onChange={this.handleChange} />
